...
namespace MVCAddressBook.Controllers
{
    public class ContactsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ContactId,FirstName,LastName,StreetAddress,City,State,HomePhone,WorkPhone,CellPhone,FaxNumber,Email,CategoryId,Category")] Contact contact, IFormFile Profile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ContactId,FirstName,LastName,StreetAddress,City,State,HomePhone,WorkPhone,CellPhone,FaxNumber,Profile,ContentType,Email,CategoryId,Category")] Contact contact, IFormFile NewProfile)
        {
            if (id != contact.Id)
            {
                return NotFound();
